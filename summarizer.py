...
def generate_summary(url):
    ...
    Instructions:
    1. If the content is a web article or YouTube video caption, provide a medium sized summary containing main points from the Text in the following format:
        - **Topic**: 
        - **Summary**: 
